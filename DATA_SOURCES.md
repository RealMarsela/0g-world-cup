...
The historical snapshot is mirrored through `pnpm data:publish-history-storage`, which writes `proof-artifacts/player-snapshot-latest.json` and the matching public artifact. Current status: the 4.35 MB historical snapshot has been submitted to 0G Storage with root `0x536d977d3ccda6855efe75441df32fd3961259477750b80c7b1ab41dd68b4fee` and tx `0xed3a0e4cc9a2043ebe61526a372eaaa21e878185316d25e1125c8d13482f73fa`; SDK finality was still pending when the long wait was stopped, so UI/tests label it `pending-finality` rather than `live`.
