...
| 0G DA batch artifact | ready | `pnpm proof:da` builds a byte-ready DA blob from proof, data pipeline proof, Storage, Storage bundle, Storage readback, Chain, Chain readback, Chain events, escrow readiness, browser wallet E2E, wager settlement, Router Compute, direct Compute broker diagnostics, runtime Compute, runtime finalization guard, integration matrix, Cloudflare tunnel readiness, DA stack readiness, infra diagnostics, Agentic ID, Agentic ID registry, all-agent Agentic ID readback, and Agent Manager readback artifacts; current hash `0x77f1336dda44c33cbc3d8c3d2aad4370bc1f821663d08264ee6c4367764aff34` is written to `proof-artifacts/da-latest.json`; live submission depends on a valid DAEntrance contract on the selected RPC |
